...
Usage:
  ...
  uv run python -m world2data.pipeline.generate_demo --json data/outputs/scene_graph.json

  # From a video (runs full pipeline)
  uv run python -m world2data.pipeline.generate_demo --video data/inputs/video.mp4

  # Open directly in Rerun viewer
  uv run python -m world2data.pipeline.generate_demo --json data/outputs/scene_graph.json --open
"""
import os
import sys
import json
