...
try:
    from model_interfaces import _HAS_YOLO, _HAS_SAM3
except ImportError:
    _HAS_YOLO = False
    _HAS_SAM3 = False
...
class TestHumanReviewJSON:
    ...
    def test_review_json_structure(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            from demo_run import _generate_review_json
...
class TestUSDAccuracyAttributes:
    ...
    def test_usd_has_confidence_attributes(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            try:
                from scene_fusion import SceneObject4D
                pipeline.objects_4d = [
                    SceneObject4D(
...
class TestSceneFusion:
    ...
    def test_fusion_creates_objects(self):
        ...
        try:
            from scene_fusion import SceneFusion4D
            from model_interfaces import DetectionResult
        except ImportError:
    ...
    def test_confidence_computation(self):
        ...
        try:
            from scene_fusion import SceneFusion4D, SceneObject4D
