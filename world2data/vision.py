...
def project_point(
    ...
    u = intrinsics.fx_px * (x_cam / z_cam) + intrinsics.cx_px
    v = intrinsics.fy_px * (y_cam / z_cam) + intrinsics.cy_px
    return (u, v, z_cam)
...
def back_project_pixel(
    ...
    x_cam = (pixel[0] - intrinsics.cx_px) * depth_m / intrinsics.fx_px
    y_cam = (pixel[1] - intrinsics.cy_px) * depth_m / intrinsics.fy_px
